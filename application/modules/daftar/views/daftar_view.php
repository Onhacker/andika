...
<head>
    ...
    <meta name=title content="Andika dan Ria" >
            ...
            <div class="container">
                ...
                <div class="gla_logo_container clearfix">
                    ...
                    <div class="gla_logo_txt">
                        <!-- Logo -->
                        <a href="/" class="gla_logo">Andika & Ria</a>
                        
                        <!-- Text Logo -->
                        <div class="gla_logo_und">11 Januari 2023</div>
                    </div>
                </div>
    ...
    <div class="gla_slider gla_image_bck gla_fixed" data-stellar-background-ratio="0.2" data-color="#efe5dd">
        ...
        <div class="container">
            ...
            <div class="gla_slide_txt gla_slide_center_middle text-center">
                ...
                <h2 >Undangan Pernikahan<br>Rabu, 11 Januari 2023</h2>
                <div class="gla_slide_midtitle">Andika & Ria</div>
...
Kami Mengundang <?php echo $seb; ?> Untuk Menghadiri Acara Pernikahan Kami.
 ...
 <img src="<?php echo base_url("assets/und/") ?>images/gurul2.png" alt="">

                        <h4>Andika Wardhani Sayuti, S.Pd.</h4>
            ...
            <div class="col-md-6 gla_anim_box">
                ...
                <!-- <span class="gla_shop_item_sale">Sale</span> -->
                    ...
                    <a href="javascript:void(0)" class="gla_shop_item_title" style="color: #333">
 <img src="<?php echo base_url("assets/und/") ?>images/teacher2.png" alt="">
                        <h4>Besse Ria Fahira, S.Pd.</h4>
        ...
        <section class="gla_section gla_image_bck gla_fixed" data-stellar-background-ratio="0.2" data-color="#fff">
            ...
            <div class="container text-center">
                ...
                <h2>11 Januari 2023</h2>
                <h3 class="gla_subtitle">Menuju Hari Bahagia</h3>
                
                <div class="gla_countdown" data-year="2023" data-month="01" data-day="11"></div>
                ...
                <div class="gla_icon_boxes row text-center">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <a href="javascript:void(0)" class="gla_news_block">
                            ...
                            <span class="gla_news_title"><strong>Akad Nikah</strong></span>
                           
                           <p> <b>Minggu, 08 Januari 2023<br>Pukul 10.00 WITA<br></b>Di Bola Bakka, Kelurahan Bulete, Kecamatan Pitumpanua Kabupaten Wajo</p><br>
                    ...
                    <div class="col-md-6 col-sm-12">
                        <a href="javascript:void(0)" class="gla_news_block">
                           ...
                           <p> <b>Rabu, 11 Januari 2023<br>Pukul 11.00 WITA - Selesai<br></b>Di Halaman Polsek Pitumpanua, kelurahan Bulete, Kecamatan Pitumpanua, Kabupaten Wajo</p><br>
